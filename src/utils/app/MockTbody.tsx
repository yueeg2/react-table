...
export const MockTbody = (methods: { control: Control<FieldValues> | undefined; getValues: (arg0: string) => string; setValue: any; }) => ([
  createTR(1, ["Hello World!",
    ...
    <Controller
      ...
      render={({ field }) => <Input {...field} placeholder="String input only" />} />, <Controller
      name="colour"
      control={methods.control}
